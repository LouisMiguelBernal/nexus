  ...
  const generateBrief = async () => {
    ...
    try {
      const r = await fetch(`${api}/api/ai/brief`, {
        method: 'POST',
        // Backend budgets 300s per Ollama call and makes two; don't bail first.
      ...
      const stored: StoredBrief = {
        ...
        // /api/ai/brief answers 200 with an empty brief + brief_error when the
        // local LLM fails. Pinning this to null hid every LLM failure behind
        // the "no synthesis yet" placeholder.
